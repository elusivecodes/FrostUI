(function (global, factory) {
    ...
    */
     ...
     */
    function addScrollPadding(node = document$1.body) {
        const scrollSizeY = getScrollbarSize(window$1, document$1, 'y');
        const scrollSizeX = getScrollbarSize(window$1, document$1, 'x');
     ...
     * @param {HTMLElement} [node=document.body] The node.
     */
    function resetScrollPadding(node = document$1.body) {
    ...
    // Alert events
    $.addEventDelegate(document$1, 'click.ui.alert', '[data-ui-dismiss="alert"]', (e) => {
        e.preventDefault();
    ...
    // Button events
    $.addEventDelegate(document$1, 'click.ui.button', '[data-ui-toggle="button"]', (e) => {
        e.preventDefault();
    ...
    $.addEventDelegate(document$1, 'click.ui.carousel', '[data-ui-slide]', (e) => {
        e.preventDefault();
    ...
    $.addEventDelegate(document$1, 'click.ui.carousel', '[data-ui-slide-to]', (e) => {
        e.preventDefault();
    ...
    // Collapse events
    $.addEventDelegate(document$1, 'click.ui.collapse', '[data-ui-toggle="collapse"]', (e) => {
        e.preventDefault();
    ...
    function removePopper(popper) {
        ...
        $.removeEvent(document$1, 'scroll.ui.popper');
    ...
    // Dropdown events
    $.addEventDelegate(document$1, 'click.ui.dropdown keyup.ui.dropdown', '[data-ui-toggle="dropdown"]', (e) => {
    ...
    $.addEventDelegate(document$1, 'keydown.ui.dropdown', '[data-ui-toggle="dropdown"]', (e) => {
        switch (e.code) {
            case 'ArrowDown':
            case 'ArrowUp':
                e.preventDefault();
    ...
    $.addEventDelegate(document$1, 'keydown.ui.dropdown', '.dropdown-menu.show .dropdown-item', (e) => {
        let focusNode;
    ...
    $.addEvent(document$1, 'click.ui.dropdown', (e) => {
    ...
    $.addEvent(document$1, 'keyup.ui.dropdown', (e) => {
    ...
    class Modal extends BaseComponent {
        ...
        hide() {
            ...
            Promise.all([
                ...
                if (stackSize) {
                    ...
                    $.removeClass(document$1.body, 'modal-open');
                }
        ...
        show() {
            ...
            $.addClass(document$1.body, 'modal-open');
            ...
            if (this._options.backdrop) {
                ...
                $.append(document$1.body, this._backdrop);
    ...
    // Modal events
    $.addEventDelegate(document$1, 'click.ui.modal', '[data-ui-toggle="modal"]', (e) => {
        e.preventDefault();
    ...
    $.addEventDelegate(document$1, 'click.ui.modal', '[data-ui-dismiss="modal"]', (e) => {
        e.preventDefault();
    ...
    class Offcanvas extends BaseComponent {
        ...
        hide() {
            ...
            Promise.all([
                ...
                if (this._options.backdrop) {
                    $.removeClass(document$1.body, 'offcanvas-backdrop');
                }

                if (!this._options.scroll) {
                    resetScrollPadding();
                    $.setStyle(document$1.body, { overflow: '' });
                }
        ...
        show() {
            ...
            if (this._options.backdrop) {
                $.addClass(document$1.body, 'offcanvas-backdrop');
            }

            if (!this._options.scroll) {
                addScrollPadding();
                $.setStyle(document$1.body, { overflow: 'hidden' });
            }
    ...
    // Offcanvas events
    $.addEventDelegate(document$1, 'click.ui.offcanvas', '[data-ui-toggle="offcanvas"]', (e) => {
        e.preventDefault();
    ...
    $.addEventDelegate(document$1, 'click.ui.offcanvas', '[data-ui-dismiss="offcanvas"]', (e) => {
        e.preventDefault();
    ...
    $.addEvent(document$1, 'click.ui.offcanvas', (e) => {
        const target = getClickTarget(e);
    ...
    $.addEvent(document$1, 'keyup.ui.offcanvas', (e) => {
    ...
    // Tab events
    $.addEventDelegate(document$1, 'click.ui.tab', '[data-ui-toggle="tab"]', (e) => {
        e.preventDefault();
    ...
    // Toast events
    $.addEventDelegate(document$1, 'click.ui.toast', '[data-ui-dismiss="toast"]', (e) => {
        e.preventDefault();
    ...
    // Clipboard events
    $.addEventDelegate(document$1, 'click', '[data-ui-toggle="clipboard"]', (e) => {
        e.preventDefault();
    ...
    // Ripple events
    $.addEventDelegate(document$1, 'mousedown.ui.ripple', '.ripple', (e) => {
        ...
        $.addEventOnce(document$1, 'mouseup.ui.ripple', (_) => {
            animation.finally((_) => {
                $.animate(
                    ripple,
                    (node, progress) => {
    ...
    // Text expand events
    $.addEventDelegate(document$1, 'change.ui.expand input.ui.expand', '.text-expand', (e) => {
